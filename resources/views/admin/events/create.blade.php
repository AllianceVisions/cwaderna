                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="required"
                                    for="event_organizer_id">{{ trans('cruds.event.fields.event_organizer_id') }}</label>
                                <select
                                    class="form-control select2 {{ $errors->has('event_organizer_id') ? 'is-invalid' : '' }}"
                                    name="event_organizer_id" id="event_organizer_id" required>
                                    @foreach ($event_organizers as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('event_organizer_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                        </option>
                                    @endforeach
                                </select>
