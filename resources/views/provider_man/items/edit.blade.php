...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("provider-man.items.update", [$item->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf

            <input type="hidden" name="provider_man_id" value="{{auth()->user()->provider_man->id}}">
...
<script>
    Dropzone.options.photoDropzone = {
        url: '{{ route('provider-man.items.storeMedia') }}',
        maxFilesize: 2, // MB
