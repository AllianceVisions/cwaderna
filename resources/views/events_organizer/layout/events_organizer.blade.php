...
<body class="c-app">
    ...
    @include('events_organizer.inc.events_organizer_side_nav')

    <div class="c-wrapper">
      
      @include('events_organizer.inc.events_organizer_nav')
      ...
      function frontendflash(message,type){ 
        ...
        $(function() {
          ...
          $.extend(true, $.fn.dataTable.defaults, {
            ...
            //         delete data.columns[i].search; // remove column search from statesave 
            //     }
            //     delete data.search; // remove global search from statesave
            // },
            dom: 'lBfrtip<"actions">',
            buttons: [
              {
