...
return [
    ...
    'from_receive_at'                      => 'From Receive At',
    'to_receive_at'                        => 'To Receive At',
    'edit'                                 => 'Edit',
    'active'                               => 'Active',
    'unactive'                             => 'Un Active',
    'price_menu'                           => 'Price Menu',
    ...
    'register_new'                         => 'ٌRegister New Account',
    'have_account'                         => 'Have already account ? Login now',
    ...
    'user_type' => [
        ...
        'staff' => 'Staff',
        'cader' => 'Cader',
        'events_organizer' => 'Event Organizer',
    ],
    'datatables'                           => [
        'copy'          => 'Copy',
        'csv'           => 'CSV',
    ...
    'total'                                => 'Total',
    'show_all'                             => 'Show All',
    'month_salery'                         => 'Month Salery',
    'commission_order_mission'             => 'Commission Orders and Misssions for Month',
    'orders_commission'                    => 'Orders Commission',
    'statistics_month'                     => 'Statistics For Month',
    'stock' => [
        'order_added_to_stock' => 'Order Added To Stock Successfully',
        'order_exist' => 'Order Already Exist',
        'order_not_found' => 'Order Not Fount',
        'order_added_before' => 'Order Added Before',
    ],
    'months' => [
        'january'=>'January',
        'february'=>'February',
    ...
    'show_company' => [
        ...
        'available' => 'Available Next Mission',
        'shipping_cost_profit' => 'Shipping Cost Profit',
    ...
    'dashboard' => [
        ...
        'order' => [
            ...
            'done' => 'Done',
            'returned' => 'Returned',
            'returned_with_company' => 'Returned with company',
            'pending' => 'Pending',
            'supplied' => 'Supplied',
            'wating' => 'Wating',
            'try_one' => 'Try One',
            'try_two' => 'Try Two',
            'try_three' => 'Try Three',
            'on_supplied' => 'On Supplied',
            'with_delivery_man' => 'With Delivery Man',
            'sent' => 'Sent', 
            'profit' => 'Orders Shipping Cost Proft',
            'count' => 'Orders Count',
        ],
        'latest_companies' => 'Latest Registered Request Companies',
        'latest_missions' => 'Latest Missions Requests',
    ],
    'order' => [
        'order_status'  => [
            'draft'     => 'Draft',
        ...
        'return_status' => [
            'with_company' => 'Returned With Company',
            'returned_to_store'   => 'On Way To Return',
            'returned_done'   => 'Returned',
            'no_thing' => 'No Thing To Return',
        ],
    ],
    'mission' => [
        'mission_status' => [
        ...
        'receive_by' => [
            'company'      => 'In Company',
            'delivery_man' => 'With Delivery Man',
            'bank'         => 'Bank',
        ],
    ],
    'flash' => [
